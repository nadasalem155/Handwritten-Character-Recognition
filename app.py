...
model = load_model("D:\\Downloads\\project\\handwritten_cnn_model.keras")  # Full path for clarity
...
label_to_index, index_to_label = load_label_mapping("D:\\Downloads\\project\\english.csv")
